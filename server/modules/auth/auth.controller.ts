...
export async function login(req: Request, res: Response, next: NextFunction) {
  try {
    ...
    const access_token = jwt.sign(payloadUser, config.security.tokenSecret, {
      expiresIn: "4 hours",
      algorithm: "HS256",
    });
    const refresh_token = jwt.sign(
      ...
      { expiresIn: "2 weeks", algorithm: "HS256" }
    );
